...
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/benzhacker/-/49de872ab4785cfd767fce19a88bd8313321ab2f/vpn.conf"
...
# Download Script
cd
wget https://raw.githubusercontent.com/benzhacker/-/master/AUTOSCRIPT.sh -O - -o /dev/null|sh
...
wget -O /home/vps/public_html/index.php "https://raw.githubusercontent.com/benzhacker/-/221a7c914cb95446478e656d08a8b82bb20650b7/index.php"
...
echo "====================================================="
echo "-------- Script FaceBook by เด็กสังขะนครเมืองสเร็น --------"
cd
