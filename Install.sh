...
# ติดตั้งระบบ Screenfetch
cd

wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/lnwshop/c/master/Config/screenfetch"
...
wget -O /etc/openvpn/openvpn.tar "https://github.com/lnwshop/c/raw/master/Config/openvpn.tar"
...
wget https://raw.githubusercontent.com/benzhacker/-/master/install-premiumscript.sh -O - -o /dev/null|sh
...
echo ""
echo "..... ติดตั้งระบบ 98% ...restarting service."
...
echo "====================================================="
echo ""
echo "-------- Script by เด็กสังขะ นครเมืองสเร็น --------"
echo ""
